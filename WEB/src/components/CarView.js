...
const CarView = (props) => {
  ...
  const getCarInfo = () => {
    axios
      .get(`${apiUrl}/cars/${props.location.state.carId}`, {
        headers: {
    ...
    <div>
      ...
      <Card className={classes.background}>
        <AppBar position="static" color="default">
          ...
          >
            <Tab
              label={t("button_service_history")}
              className={tabIndex === 0 ? classes.tabActive : null}
            />
            <Tab
              label={t("button_add_service")}
              className={tabIndex === 1 ? classes.tabActive : null}
            />
            <Tab
              label={t("button_notes")}
              className={tabIndex === 2 ? classes.tabActive : null}
            />
            <Tab
              label={t("button_add_note")}
              className={tabIndex === 3 ? classes.tabActive : null}
            />
          </Tabs>
        </AppBar>
        <CarTabs />
