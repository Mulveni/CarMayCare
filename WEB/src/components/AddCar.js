...
// Puuttuu: 401 responsen käsittely ja viestiminen käyttäjälle.
...
const AddCar = () => {
  ...
  const onSubmit = data => {
    axios.post(`${apiUrl}/cars`, data, {
      ...
      history.push("/mycars"); // user returns back to /mycars
